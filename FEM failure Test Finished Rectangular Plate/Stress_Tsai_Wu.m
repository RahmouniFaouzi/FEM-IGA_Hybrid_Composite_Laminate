function [stress_layer,Tsai_Wu_max,Pli_etude,effort_min,failure_C] = Stress_Tsai_Wu( ndof,Nlyer,...
...
for e = 1:numberElements
    ...
    for q = 1:size(gaussWeights,1)
        ...
        % Failures Criteria
        [Tsai_Wu_max,  Pli_etude,~,effort_min, failure_C] = Tsai_Wu_failure (Nlyer,Str_G,CLS,strength, theta,Tsai_Wu_max,Pli_etude,effort_min);
